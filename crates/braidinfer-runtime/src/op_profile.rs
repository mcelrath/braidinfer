...
/// Map opcode id → human name. Mirrors kernels/opcodes.h exactly.
/// Unknown ids return "OP_UNKNOWN".
pub fn opcode_name(op: u32) -> &'static str {
    match op {
        ...
        28 => "OP_SILU_MUL",
        29 => "OP_SSM_UPDATE",
        30 => "OP_FFN_GATE_UP_RNF4",
        31 => "OP_FFN_DOWN_RES_RNF4",
        ...
        37 => "OP_RELU_SQ",
        38 => "OP_MAMBA2_CONV1D",
        39 => "OP_MAMBA2_NORM_GATED",
        40 => "OP_CONV1D_3X",
        41 => "OP_FFN_GATE_UP_WX",
        42 => "OP_FFN_GATE_UP_RNF4_WX",
        43 => "OP_LINEAR_PROJ_2X",
        44 => "OP_MOE_FFN_REMOTE",
        45 => "OP_MOE_DISPATCH_POST",
        _ => "OP_UNKNOWN",
    }
}
